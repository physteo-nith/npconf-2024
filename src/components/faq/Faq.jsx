...
import { FaLinkedin, FaGithub, FaInstagram, FaTwitter, FaInstagramSquare } from 'react-icons/fa';
...
const FAQ = () => {
    ...
    return (
        <div className="min-h-screen bg-black flex items-center justify-center p-4">
            <motion.div
                ref={ref}
                className="w-full max-w-5xl bg-green-200 p-6 rounded-lg shadow-md flex flex-col md:flex-row"
                initial="hidden"
                animate={controls}
            ...
            >
                ...
                <div className="md:w-1/2 md:pr-4">
                    <h1 className="text-3xl font-bold mb-6 text-zinc-800">Frequently asked questions</h1>
                    {faqs.map((faq, index) => (
                        <motion.div
                            key={index}
                            className="mb-4"
                ...
                <motion.div
                    ...
                    variants={itemVariants}
                >
                    <h1 className="text-4xl font-bold mb-8 text-zinc-800">Contact Us</h1>
                    <div className="flex space-x-8">
                        ...
                        <a href="https://github.com/physteo-nith" className="text-4xl text-black hover:text-gray-700 transition-colors duration-300 icon-hover">
                            <FaGithub />
                        </a>
                        <a href="https://www.instagram.com/physteo?igsh=enh1NWFucDJ5NGc4" className="text-4xl text-pink-700 hover:text-pink-800 transition-colors duration-300 icon-hover">
                            <FaInstagram />
                        </a>
